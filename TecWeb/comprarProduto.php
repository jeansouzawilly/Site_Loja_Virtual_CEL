				...
				<div class="col-sm-9 padding-right">
					...
					?> 
						...
						<div class="col-sm-5">
							<div class="view-product">
								<img src="images/home/<?php echo $celular['caminhoImagem'] ?>" alt="" />
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<h2><?php echo $celular['nome']; ?></h2>
								<span>
									<span>R$ <?php echo $celular['preco']; ?></span>
									<label>Quantidade:</label>
									<input type="text" value="" />
									<a href="carrinho.php?id=<?php echo $_GET['id']?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Comprar</a>
									<!--<button href="carrinho.php" type="button" class="btn btn-fefault cart">
										<i class="fa fa-shopping-cart"></i>
										Comprar
									</button>-->
								</span>
								<p><b><?php echo $celular['quantidade']; ?></b> Em Estoque</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							...
							<p><?php echo $celular['descricao']; ?></p>
						</div>
